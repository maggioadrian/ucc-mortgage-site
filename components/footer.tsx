...
const footerColumns = [
  {
    title: "Borrowers",
    links: [
      { label: "Commercial Financing", href: "/solutions/commercial"       },
      ...
      { label: "All Solutions",        href: "/borrowers"                  },
    ],
  },
  {
    title: "Investors & Partners",
    links: [
      { label: "Private Mortgage Investing", href: "/investors"           },
      { label: "Investment Process",         href: "/investors#process"   },
      { label: "Partner With Us",            href: "/partners"            },
      { label: "Submit a Referral",          href: "/partners#referral"   },
      { label: "Book Investor Call",         href: "/contact"             },
    ],
  },
  {
    title: "Company & Tools",
    links: [
      ...
      { label: "Deal Submission",         href: "/tools/deal-submission"        },
      { label: "Investor Calculator",     href: "/tools/investor-calculator"    },
    ],
  },
];
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-4 text-sm text-muted-foreground leading-relaxed">
              Windsor&apos;s commercial &amp; private mortgage specialists.
            </p>
