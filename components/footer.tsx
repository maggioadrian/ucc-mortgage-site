      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
              ...
              <ul className="space-y-3">
                {column.links.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="text-sm text-muted-foreground hover:text-[#27aae1] transition-colors"
                    >
                      {link.label}
                    </Link>
                  </li>
        ...
        <div className="mt-16 pt-8 border-t border-[#1a1f22] flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            <Link href="#" className="text-xs text-muted-foreground hover:text-[#27aae1] transition-colors">
              Privacy Policy
            </Link>
            <Link href="#" className="text-xs text-muted-foreground hover:text-[#27aae1] transition-colors">
              Terms of Service
            ...
            <span className="text-xs text-muted-foreground">
              Brokerage #10675 | Administrator #11657
            </span>
          </div>
        </div>
      </div>
