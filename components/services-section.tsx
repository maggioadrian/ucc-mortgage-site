...
export function ServicesSection() {
  return (
    <section id="solutions" className="py-24 bg-[#0e1214]">
        ...
        <div className="grid lg:grid-cols-3 gap-5">
          ...
          >
            <Link href="/solutions/commercial" className="block h-full">
              <div
                className="h-full p-8 rounded-2xl border border-[#006f7f]/30 hover:border-[#27aae1]/50 transition-all duration-300 hover:shadow-[0_0_36px_rgba(39,170,225,0.10)]"
                style={{ background: "linear-gradient(135deg, rgba(0,111,127,0.10) 0%, #161c1f 40%, #0e1214 100%)" }}
              >
                <div className="flex items-start justify-between mb-6">
                  <div className="flex items-center gap-3">
                    <div className="p-3 rounded-xl bg-[#27aae1]/12">
                      <Building2 className="w-6 h-6 text-[#27aae1]" />
                    </div>
                    <span className="text-xs font-semibold px-3 py-1 rounded-full bg-[#27aae1]/10 border border-[#27aae1]/20 text-[#27aae1]">
                      Priority
                    </span>
                  </div>
                </div>
          ...
          >
            <Link href="/solutions/residential" className="block h-full">
              <div
                className="h-full p-7 rounded-2xl border border-[#27aae1]/10 hover:border-[#27aae1]/35 transition-all duration-300 hover:shadow-[0_0_20px_rgba(39,170,225,0.08)]"
                style={{ background: "linear-gradient(145deg, #161c1f 0%, #0e1214 100%)" }}
              >
                <div className="p-3 rounded-xl bg-[#27aae1]/10 w-fit mb-5">
                  <Home className="w-5 h-5 text-[#27aae1]" />
                </div>
          ...
          >
            <div
              className="p-8 rounded-2xl border border-[#006f7f]/35 hover:border-[#27aae1]/50 transition-all duration-300 hover:shadow-[0_0_36px_rgba(0,111,127,0.12)]"
              style={{ background: "linear-gradient(135deg, rgba(0,111,127,0.09) 0%, #161c1f 45%, #0e1214 100%)" }}
            >
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-5">
                    <div className="p-3 rounded-xl bg-[#006f7f]/20">
                      <Landmark className="w-6 h-6 text-[#27aae1]" />
                    </div>
                ...
                <div className="flex flex-wrap gap-3 lg:flex-shrink-0">
                  <Link
                    ...
                    className="group/btn inline-flex items-center gap-2 px-6 py-3 bg-[#27aae1] text-[#0e1214] text-sm font-semibold rounded-full transition-all hover:shadow-[0_0_24px_rgba(39,170,225,0.35)]"
                  >
                  ...
                  <Link
                    href="/investors"
                    className="inline-flex items-center gap-2 px-6 py-3 border border-[#006f7f]/50 text-[#27aae1] text-sm font-semibold rounded-full hover:border-[#27aae1]/60 hover:bg-[#27aae1]/5 transition-all"
                  >
