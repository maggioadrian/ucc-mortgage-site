...
import { ArrowRight, Home, Building2, Landmark, CreditCard, HardHat, PiggyBank } from "lucide-react";

const services = [
  {
    id: "01",
    title: "Residential",
    description: "Whether you're a first-time buyer, refinancing, or renewing — we find the best rate from 40+ lenders. Investment properties, second homes, and vacation properties welcome.",
    stat: "$1.2B+",
  ...
  },
  {
    ...
    description: "Alternative lending when traditional banks say no. Fast approvals for unique situations.",
    icon: Landmark,
  },
  {
    id: "04",
            ...
            >
              ...
              >
                ...
                <div className="flex items-end justify-between">
                  ...
                  <button className="inline-flex items-center gap-2 text-sm font-medium text-[#27aae1] opacity-0 group-hover:opacity-100 transition-opacity">
