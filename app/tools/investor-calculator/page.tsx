        ...
        <section className="pt-24 pb-16"
          ...
          <div className="max-w-2xl mx-auto px-6 text-center">
            <div className="inline-flex p-3 rounded-xl bg-[#006f7f]/10 mb-6">
              <TrendingUp className="w-6 h-6 text-[#006f7f]" />
            </div>
          ...
          <div className="max-w-2xl mx-auto px-6 space-y-6">
                        ...
                        <button key={r} type="button" onClick={() => setRate(r)}
                          className={`flex-1 py-1.5 text-xs rounded-lg border transition-colors ${
                            rate === r
                              ...
                              : "border-[#2a2420] text-muted-foreground hover:border-[#006f7f]/30"
                          }`}>
                          {r}%
                        </button>
                      ))}
            ...
            {p > 0 && r > 0 && (
              <div className="p-8 rounded-2xl border border-[#006f7f]/20"
                ...
                <Link href="/contact"
                  className="w-full flex items-center justify-center gap-2 py-3.5 bg-[#006f7f] text-[#141210] font-semibold rounded-full transition-all hover:shadow-[0_0_24px_rgba(0,111,127,0.35)]">
