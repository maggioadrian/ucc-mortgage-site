          ...
          {solution.slug === "farm-agriculture" ? (
            <div className="absolute right-12 top-1/2 -translate-y-1/2 hidden lg:flex flex-col items-center gap-3 pointer-events-none">
              <div className="p-6 rounded-2xl border border-[#006f7f]/20 bg-[#006f7f]/05"
                style={{ background: "linear-gradient(135deg, rgba(0,111,127,0.10) 0%, rgba(20,18,16,0.80) 100%)" }}>
                <Leaf className="w-8 h-8 text-[#006f7f]/30 mb-3 mx-auto" />
            ...
            <div className="absolute right-12 top-1/2 -translate-y-1/2 hidden lg:block pointer-events-none">
              <div className="w-64 h-64 rounded-full bg-[#006f7f]/5 flex items-center justify-center">
                <div className="w-40 h-40 rounded-full bg-[#006f7f]/8 flex items-center justify-center">
                  <HeroIcon className="w-20 h-20 text-[#006f7f]/20" />
                </div>
              </div>
            </div>
          )}
              ...
              {solution.benefits.map((benefit, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className="group p-6 rounded-xl border border-[#006f7f]/10 hover:border-[#006f7f]/35 transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,111,127,0.1)]"
                    style={{
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <motion.div
                ...
                viewport={{ once: true, margin: "-100px" }}
                transition={{ duration: 0.5, delay: 0.2 }}
                className="p-8 rounded-xl border border-[#006f7f]/15"
                style={{
                  background:
                    "linear-gradient(135deg, rgba(0,111,127,0.08) 0%, rgba(20,18,16,1) 70%)",
                }}
              >
                ...
                <Link
                  href="/contact"
                  className="group inline-flex items-center gap-2 px-6 py-3 bg-[#006f7f] text-[#141210] font-semibold rounded-full text-sm transition-all hover:shadow-[0_0_20px_rgba(0,111,127,0.35)]"
                >
                  Speak to a broker
